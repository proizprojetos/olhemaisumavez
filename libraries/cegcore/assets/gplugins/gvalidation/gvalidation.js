jQuery(document).ready(function($){
	var GValidtaion = {
		...
		errors : {
			...
			alpha : 'Este campo aceita apenas valores alfanuméricos.',
			alphanum : 'Este campo aceita apenas caracteres alfanuméricos.',
	...
	$.fn.show_gvalidate_error = function(rule){
		...
		if(!$this.hasClass('gvalidate_error_shown')){
			...
			if(GValidtaion.display == 'tooltip'){
				$this.gtooltip({'tipclass':'gtooltip gvalidation-error-tip'});
