...
Class HandleArrays {
	...
	public static function config(){
		...
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][{N}][delimiter]', array('type' => 'text', 'label' => l_('CF_DELIMITER'), 'value' => ',', 'class' => 'SSS', 'sublabel' => l_('CF_DELIMITER_DESC')));
