...
Class CustomCode {
	...
	public static function config($configs = array(), $extra_config = array()){
		...
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][{N}][content]', array('type' => 'textarea', 'label' => l_('CF_CONTENT'), 'rows' => 20, 'cols' => 70, 'sublabel' => l_('CF_CONTENT_CUSTOM_CODE_DESC')));
