...
class Dropdown {
	...
	static $configs = array(
		'name' => array('value' => 'dropdown{N}', 'label' => 'Field Name', 'type' => 'text', 'class' => 'element_field_name L'),
			...
			foreach($data['events'] as $i => $event){
				echo \GCore\Helpers\Html::formLine('Form[extras][fields]['.$k.'][events][required]', array('type' => 'multi', 'layout' => 'wide',
					'inputs' => array(
						...
						array('type' => 'dropdown', 'name' => 'Form[extras][fields]['.$k.'][events]['.$i.'][action]', 'options' => array('' => '', 'enable' => 'enable', 'disable' => 'disable', 'show' => 'show', 'hide' => 'hide', 'set_options' => 'Set Options', 'function' => 'function'), 'sublabel' => 'Action', 'style' => 'width:auto;'),
