	...
	<div class="panel panel-default">
		<div class="panel-body">
			<form action="<?php echo r_('index.php?ext=chronoforms&act=validateinstall'); ?>" method="post" name="admin_form" id="admin_form">
				...
				<?php echo $this->Html->formLine('pid', array('type' => 'dropdown', 'label' => 'Product', 'class' => 'L', 'options' => array(14 => 'ChronoForms 3 validation keys subscription', 4 => 'ChronoForms 5 validation keys subscription', 6 => 'ChronoForms Ultimate subscription'), 'sublabel' => 'Your subscription type')); ?>
