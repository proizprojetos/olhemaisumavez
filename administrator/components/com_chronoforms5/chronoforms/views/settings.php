			...
			<form action="<?php echo r_('index.php?ext=chronoforms&act=save_settings'); ?>" method="post" name="admin_form" id="admin_form">	
				...
				<div class="tab-content">
					<div id="emails" class="tab-pane active">
						...
						<?php echo $this->Html->formLine('Chronoforms[mail][smtp_host]', array('type' => 'text', 'label' => l_('CF_SMTP_HOST'))); ?>
						<?php echo $this->Html->formLine('Chronoforms[mail][smtp_port]', array('type' => 'text', 'label' => l_('CF_SMTP_PORT'))); ?>
						<?php echo $this->Html->formLine('Chronoforms[mail][smtp_username]', array('type' => 'text', 'label' => l_('CF_SMTP_USERNAME'))); ?>
						<?php echo $this->Html->formLine('Chronoforms[mail][smtp_password]', array('type' => 'text', 'label' => l_('CF_SMTP_PASSWORD'))); ?>
