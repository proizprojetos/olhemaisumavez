...
function addFieldEvent(elem, button_id){
	...
	//clone one in the real config div
	...
	jQuery(document).ready(function($) {
		...
		function addContainer(container){
			...
			var new_container = $('<div/>',{
				'class':'element_box panel panel-success',
		...
		function addField(container, field_type){
			...
			var $new_element_box = $('<div/>', {'class':'element_box panel panel-default'});
		...
		function addMultiField(container){
			...
			var $new_element_box = $('<div/>', {'class':'element_box panel panel-warning'});
			var obj = {};
		...
		jQuery(document).ready(function($){
			...
			function addEvent(){
				var event_box = $('<div/>', {
					...
					$('<label/>', {'class':'form_event_label', text:'On '+$('#new_event_name').val()})
				).append(
			...
			<div class="panel-body">
				<div class="tab-content">
					<div id="general" class="tab-pane active">
						...
						<?php echo $this->Html->formLine('Form[title]', array('type' => 'text', 'id' => 'cform_name', 'label' => l_('CF_FORM_NAME'), 'class' => 'XL validate["required"]', 'sublabel' => l_('CF_FORM_NAME_DESC'))); ?>
												...
												if(!empty($this->data['Form']['extras']['fields'])){
													...
													foreach($this->data['Form']['extras']['fields'] as $k => $wizard_field){
														...
														if($wizard_field['type'] == 'container'){
															...
															echo '<div class="element_box panel panel-success" id="fields_container_'.$k.'" container_num="'.$k.'">';
															echo '
																<div class="panel-heading">
																	<div class="pull-left">
																	...
																	<div id="field_icons_'.$k.'" class="field_icons pull-right"><span class="edit_icon edit_container_icon action_icon label label-primary" title="Edit">Edit</span><span class="drag_icon action_icon label label-warning" title="Drag">Drag</span><span class="delete_icon delete_container_icon action_icon label label-danger" title="Delete">Delete</span></div>
															...
															echo '<div class="element_box field_box panel panel-default">';
						...
						<div id="boxes-container" class="container" style="width:100%;">
							...
							<div class="row"<?php if(!empty($this->data['setup']) OR !empty($this->data['Form']['params']['setup'])): ?> style="display:none;"<?php endif; ?>>
													...
													<div class="panel-body">
														...
														<?php foreach($actions as $action): ?>
															...
															<div class="action_source_item" id="<?php echo $action; ?>" title="<?php echo $action_class::$title; ?>" style="margin:1px;">
																<span class="btn btn-primary btn-xs btn-block"><?php echo $action_class::$title; ?></span>
								...
								<div class="form_event main_event good_event alert alert-success" id="FormOn<?php echo \GCore\Libs\Str::camilize($event); ?>Event">
									<label class="form_event_label label label-success">On <?php echo $event; ?></label>
						...
						<ul class="nav nav-tabs" id="locales_tabs_heads" style="margin-top:10px;">
							<?php if(isset($this->data['Form']['extras']['locales'])):	?>
								<?php foreach($this->data['Form']['extras']['locales'] as $k => $locale): ?>
									<li class=""><a href="#<?php echo $k; ?>" data-g-toggle="tab"><?php echo $k; ?></a></li>
								<?php endforeach; ?>
							<?php endif; ?>
						</ul>
							...
							<?php if(isset($this->data['Form']['extras']['locales'])):	?>
								<?php foreach($this->data['Form']['extras']['locales'] as $k => $locale): ?>
									<div class="tab-pane" id="<?php echo $k; ?>">
										...
										<?php echo $this->Html->formSecEnd(); ?>
										<?php echo $this->Html->formEnd(); ?>
										<button class="remove_locale_button btn btn-danger" onclick="remove_locale('<?php echo $k; ?>');">
...
<div id="locale_generic_config" class="generic_config" title="Generic" style="display:none;">
	...
	<?php echo $this->Html->formSecEnd(); ?>
	<?php echo $this->Html->formEnd(); ?>
	<button class="remove_locale_button btn btn-danger" onclick="remove_locale('{N}');">
		<?php echo l_('REMOVE_LOCALE'); ?>
	</button>
</div>
