 ...
 *
 */
require_once(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_loja'.DS.'libs'.DS.'highroller'.DS.'HighRollerChart.php');
require_once(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_loja'.DS.'libs'.DS.'highroller'.DS.'HighRollerTitle.php');
require_once(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_loja'.DS.'libs'.DS.'highroller'.DS.'HighRollerSeries.php');
require_once(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_loja'.DS.'libs'.DS.'highroller'.DS.'HighRollerOptionsGlobal.php');
require_once(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_loja'.DS.'libs'.DS.'highroller'.DS.'HighRollerOptions.php');
class HighRoller {
