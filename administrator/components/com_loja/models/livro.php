...
class LojaModelLivro extends JModelAdmin {

	protected $data;
	
	public function getTable($type="Livro", $prefix="LojaTable", $config=array() ) {
		return JTable::getInstance($type, $prefix, $config);	
	}
	
	public function getForm($data = array(), $loadData = true) {
	
		$form = $this->loadForm('com_loja.livro', 'livro', array('control' => 'jform', 'load_data' =>$loadData));
	...
	*/
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_loja.edit.livro.data', array());
		if (empty($data)) 
		{
			$data = $this->getItem();
		}
	...
	{		
		...
		if(!empty($autores)) {
			...
			$this->_db->setQuery(
				'INSERT INTO #__loja_livros_autores (id_livro, id_autor) VALUES ' .
				implode(',', $tuples)
			);
