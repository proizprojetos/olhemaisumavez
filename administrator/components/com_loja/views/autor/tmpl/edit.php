...
<script type="text/javascript">
	...
	{
		if (task == 'autor.cancel' || document.formvalidator.isValid(document.id('autor-form')))
		{
...
<form action="<?php echo JRoute::_('index.php?option=com_loja&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="autor-form" class="form-validate form-horizontal" enctype="multipart/form-data">
	...
	<fieldset>
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', JText::_('Dados do autor',true)); ?>
			
			<?php foreach ($this->form->getFieldset('detalhes_autor') as $field) { ?>
