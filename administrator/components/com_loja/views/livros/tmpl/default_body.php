...
<form action="<?php echo JRoute::_('index.php?option=com_loja&view=livros'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<tbody>
			<?php foreach ($this->itens as $i => $item) { ?>
				...
				<tr class="row<?php echo $i %2; ?>">
					...
					<td class="center">
						<a href="<?php echo JRoute::_('index.php?option=com_loja&task=livro.edit&id='.(int) $item->id); ?>" title="">
