...
require_once (dirname(__FILE__).'/toolbar.feedgator.html.php');

$bar = JToolBar::getInstance('toolbar');
$bar->addButtonPath(dirname(__FILE__).'/buttons');

switch (strtolower(JFactory::getApplication()->input->get( 'task','','CMD' )))
