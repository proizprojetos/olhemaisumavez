	...
	<tbody>
		<tr>
			...
			<td valign="top" width="45%">
				<?php
				echo JHtml::_('sliders.start','feedgator_default',$options);
				echo JHtml::_('sliders.panel','FeedGator','panel1');
					echo JText::_('FG_DESCRIPTION');
					FeedgatorHelper::renderVersionUpdatePanel($this->version_data);
				echo JHtml::_('sliders.panel','Latest Imports','panel2');
				    ...
				    <?php }
				echo JHtml::_('sliders.panel','Credits','panel3');
				?>
					<ul>
